...
The heat maps that match the example in figure~\ref{fig:topology-matrix-90m-5} shows two identical topologies, in which the communication range is set to 100m, and the maximum node degree is arbitrarily set to 5.
